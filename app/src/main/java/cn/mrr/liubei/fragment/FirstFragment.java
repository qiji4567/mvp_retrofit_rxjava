...
public class FirstFragment extends BaseMVPFragment {
    ...
    @Override protected int getLayoutId() { return R.layout.layout1; }
    @Override protected void initialize() { binding = Layout1Binding.bind(mView); binding.text.setOnClickListener(v -> startActivity(mActivity, ImageViewActivity.class, false)); }
}
