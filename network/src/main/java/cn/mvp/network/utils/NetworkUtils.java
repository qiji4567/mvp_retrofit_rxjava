...
public class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) ApplicationContextUtils.getInstance()
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) ApplicationContextUtils.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) ApplicationContextUtils.getInstance().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
